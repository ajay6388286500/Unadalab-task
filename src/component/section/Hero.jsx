...
const Hero = () => {
  return (
    <div className="leading-[0.8] select-none ">
      ...
      <h1 className="text-[20vw] sm:text-[28vw] font-bold text-black/90 tracking-tight">
        Juan
      </h1>
      <h1 className="text-[20vw] sm:text-[28vw] font-bold text-black/90 tracking-tight -mt-[5vw] mb-6 sm:mb-[6vw]">
        mora
      </h1>
    </div>
  );
